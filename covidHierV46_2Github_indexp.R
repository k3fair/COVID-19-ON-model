...
print(c((as.numeric(args[1])/100 - 0.01), (as.numeric(args[1])/100)))
...
ncperc.set<-seq((as.numeric(args[1])/100 - 0.01), (as.numeric(args[1])/100), 0.01); 
susceffect.set<-0.5
...
saveRDS(df.region.comb, file = sprintf("simsREGIONS_suscRAND_ncincr_%s_susceffect%.2f_%.2f_%.2f_V2.rds", codeversion, susceffect, (as.numeric(args[1])/100 - 0.01), (as.numeric(args[1])/100) ));
saveRDS(df.prov.comb, file = sprintf("simsPROVINCE_suscRAND_ncincr_%s_susceffect%.2f_%.2f_%.2f_V2.rds", codeversion, susceffect, (as.numeric(args[1])/100 - 0.01), (as.numeric(args[1])/100) ));
saveRDS(df.fitparms.comb, file = sprintf("simsFITPARMS_suscRAND_ncincr_%s_susceffect%.2f_%.2f_%.2f_V2.rds", codeversion, susceffect, (as.numeric(args[1])/100 - 0.01), (as.numeric(args[1])/100) ));
