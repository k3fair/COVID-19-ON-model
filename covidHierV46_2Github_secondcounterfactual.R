...
saveRDS(df.region.comb, file = sprintf("simsREGIONS_all_CFW2REOPEN_%s_%s_%s_V2.rds", codeversion, cftype, reopeningtype));
saveRDS(df.prov.comb, file = sprintf("simsPROVINCE_all_CFW2REOPEN_%s_%s_%s_V2.rds", codeversion, cftype, reopeningtype));
saveRDS(df.fitparms.comb, file = sprintf("simsFITPARMS_all_CFW2REOPEN_%s_%s_%s_V2.rds", codeversion,  cftype, reopeningtype));
