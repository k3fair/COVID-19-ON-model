#     covidHier48_Github_parmfit.R runs fitting algorithms for COVID-19-ON-model
...
m3iter=function(S,parms,timeinfo,seed,Ns=parms[,"N"]){
  ...
  #Make modified travel matrices for regions where there are closures of workplaces and/or schools
